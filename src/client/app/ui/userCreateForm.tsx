...
export default function Form() {
     ...
     return (
          <form action={dispatch}>
               ...
               <div className="mb-3">
                    <label className="form-label fs-bold required" htmlFor="password">Jelszó:</label>
               ...
               <div className="mb-3">
                    <label className="form-label fs-bold required" htmlFor="password_rep">Jelszó újra:</label>
               ...
               <div className="mb-3">
                    <label className="form-label fs-bold required" htmlFor="role">Jogosultság kör:</label>
